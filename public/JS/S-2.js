...
function who_are_you (){
    ...
    if (userAge < 10){
        ...
        switch (social ){
            case "youtube":
                alert("Контент - это жизнь. Понимаю!");
            ...
            case "instagram":
                alert("So good.");
                description ="Главное - не жизнь, а красивый завтрак. Одобряю.";
                break;
            case "vk":
            alert("Старое доброе ВК. Классика.");
            description ="Классика. Одобряю."
            break;
        default:
            alert("Интересный выбор. Я тебя оценил!");
            description ="Вне матрицы. Я не знаю как ты сюда попал."
    }
